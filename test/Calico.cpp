/*
 * PROJECT CALICO | CubeCats CATiSE Program (2024-2025)
 * ===================================================
 * Main Mission Firmware
 * Description: Handles multi-sensor data collection, local SD logging, 
 * image capture, and Iridium SBD satellite transmission.
 * DIGITAL PIN MAPPING:See 'Wiring_and_Notes.txt' for full details
 * =====================================================
 * For inquiries contact: Kareem Ahmed
 * Email: ahmedke@mail.uc.edu | Discord: @kareem_xyz
 * UC CubeCats https://uccubecats.github.io/
*/
...
// Libraries (Some are availble in the repo files)
  #include <Arduino.h>
...
// DataPacket Struct Info: Not used as a class due to tranmission.
  struct __attribute__((packed)) DataPacket {
    /* Info
      ...
      Furthermore, there are 3 bytes included in the final message (1 for complete packet lineCount, and 2 for a xor checksum)
      Sizes: 
